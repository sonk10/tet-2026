...
const WISH_MESSAGES = [
	...
	"Năm mới bình an, Học tập tiến tới",
	"Chúc mọi điều ước của cậu đều trở thành hiện thực ✨",
	"Chúc gia đình cậu luôn bình an và hạnh phúc ❤️",
	...
	"Chúc cậu gặp nhiều may mắn và niềm vui 🎉",
	"Chúc cậu có những trải nghiệm tuyệt vời trong năm mới 🌟",
	"Chúc cậu năm mới học giỏi tiến bộ, thành công rực rỡ!",
	"Chúc cậu năm mới vạn sự như ý, tiền vào như nước!",
	"Chúc cậu năm mới phát tài phát lộc, học tập thăng tiến!",
	"Chúc cậu năm mới sức khỏe dồi dào, tinh thần phấn chấn!",
	"Năm mới tới, mệt mỏi ở lại 🍃",
	"Tiền vô như nước 💰, lòng nhẹ như mây ☁️, ngày nào cũng có lý do để cười 😊",
	" Việc khó hóa dễ ✨, áp lực hóa động lực 🔥, ước mơ từng bước thành hình 🌈",	
...
function updateGlobals(timeStep, lag) {
	...
	// auto launch shells
if (store.state.config.autoLaunch && window.INTRO_DONE) {
